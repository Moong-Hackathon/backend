...
public class UserReservationController {
    ...
    public ApiResponse<ReservationResponseDto.ReservationStateDto> patchReservationConfirmed(
        ...
        Reservation saved = reservationCommandService
                .patchReservationStatusByMember(memberId, reservationId, CONFIRMED);
    ...
    public ApiResponse<ReservationResponseDto.ReservationStateCancelDto> patchReservationCancelByMember(
        ...
        Reservation saved = reservationCommandService
                .patchReservationStatusByMember(memberId, reservationId, CANCELED);
        return ApiResponse.ofSuccess(ReservationConverter.toCancelDto(saved, "MEMBER"));
    }
}