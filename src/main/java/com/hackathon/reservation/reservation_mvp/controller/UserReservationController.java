...
public class UserReservationController {
    ...
    public ReservationResponseDto.ReservationStateDto patchReservationConfirmed(
    ...
    public ReservationResponseDto.ReservationStateCancelDto patchReservationCancelByMember(
            @PathVariable("userId") Long memberId,
            @PathVariable("reservationId") Long reservationId) {
        Reservation reservation = reservationCommandService.patchReservationStatusByMember(memberId, reservationId, CANCELED);
        return ReservationConverter.reservationStateCancelDto(reservation, "MEMBER");
    }
}
